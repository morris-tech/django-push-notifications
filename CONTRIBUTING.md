...
1. Always use double quotes for strings, unless single quotes avoid unnecessary escapes.
2. When in doubt, [PEP8](https://www.python.org/dev/peps/pep-0008/). Follow its naming conventions.
